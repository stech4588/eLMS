                    ...
                    <div class="px-8 pb-8">
                        <div class="space-y-3">
                            <label v-for="option in goalOptions" :key="option.value" 
                                   ...
                                   :class="{
                                       'bg-green-100 dark:bg-green-900/30 border-green-500 dark:border-green-400 ring-2 ring-green-500': selectedGoal === option.value,
                                       'bg-white dark:bg-gray-700/50 border-gray-300 dark:border-gray-600 hover:border-green-400 dark:hover:border-green-500': selectedGoal !== option.value
                                   }">
