            ...
            <div class="grid grid-cols-2 gap-8 items-start section-content">
              ...
              <div class="pl-8 text-container">
                ...
                <ul class="feature-list">
                  ...
                  <li class="feature-item">
                    <svg class="feature-icon" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg>
                    <span class="feature-text">Network with over <span class="text-[#4ACFF8] font-semibold">50,000+ like-minded learners.</span></span>
                  </li>
                </ul>
              </div>
            </div>
...
<template>
  <section class="benefits-section" id="learn">
    <div class="container">
      <!-- Grid of Benefits -->
      <div class="benefits-grid">
        ...
        <div class="benefit-card">
          <div class="benefit-icon">
            <img src="/images/degree-icon.webp" alt="Life Skills" class="dark-icon" />
          </div>
          <h3>Learn Essential Life Skills</h3>
          <p class="benefit-description">
            Turn Knowledge into Income, go from beginner to earning $10k/month fast, and gain practical skills that
            directly impact your earning power.
          </p>
        </div>
        ...
        <div class="benefit-card">
          <div class="benefit-icon">
            <img src="/images/group-icon.webp" alt="Community" class="dark-icon" />
          </div>
          <h3>Join an Exclusive Community</h3>
          <p class="benefit-description">
            Grow with a Private Network. Share progress, celebrate wins, and get inspired. Network with over 50,000+
        ...
        <div class="benefit-card">
          <div class="benefit-icon">
            <img src="/images/multi-icon.png" alt="Mentorship" class="dark-icon" />
          </div>
          <h3>Mentorship from High-Level Experts</h3>
          <p class="benefit-description">
            Access Industry Leaders, get step-by-step mentoring from multimillionaires and proven experts, and receive
            personal advice tailored to your journey.
          </p>
        </div>
      </div>
...
const joinNowUrl = computed(() => {
  if (user.value) {
    if (page.props.auth.profile_incomplete) {
...
/* Ensure bright/white icons are visible on white bg by darkening them */
.dark-icon {
