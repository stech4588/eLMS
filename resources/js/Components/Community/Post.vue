            ...
            <div class="flex-1">
                ...
                <div v-if="post.attachments && post.attachments.length">
                    ...
                    <div v-if="fileAttachments.length" class="mt-2 space-y-1">
                        <a v-for="attachment in fileAttachments" :key="attachment.id" :href="attachment.file_url" target="_blank" class="text-gray-900 hover:underline flex items-center p-2 bg-gray-100 dark:bg-gray-700 rounded-lg dark:text-gray-200">
                ...
                <div class="mt-2">
                    <button
                        @click="toggleReplies"
                        class="text-gray-900 dark:text-gray-200 text-sm font-semibold flex items-center space-x-2"
                    >
                    ...
                    <div v-if="showReplies" class="mt-2">
                        ...
                        <button v-if="currentPage < lastPage" @click="fetchReplies" class="text-gray-900 dark:text-gray-200 text-sm mt-2 hover:underline">
                            Load more replies
                        </button>
                    </div>
