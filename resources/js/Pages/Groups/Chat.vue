                    ...
                    <div class="flex flex-col h-[calc(100vh-180px)]">
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-900/50 border-t dark:border-gray-700 relative">
                            ...
                            <div class="relative" ref="attachmentContainer">
                                <!-- Attachment Menu -->
                               <div v-if="showAttachmentMenu" class="absolute bottom-full left-0 mb-2 w-60 bg-light-bg-secondary dark:bg-[#1A2C38] text-light-text-primary dark:text-dark-text-primary rounded-lg shadow-lg dark:shadow-dark z-20">
                                   <ul class="py-1">
