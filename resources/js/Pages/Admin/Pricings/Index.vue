<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Pricings</h2>
        </template>
        <div class="py-12">
                ...
                <div class="bg-white dark:bg-[#2d2d2d] overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white dark:bg-[#2d2d2d] divide-y divide-gray-200">
                                <tr v-for="pricing in filteredPricings" :key="pricing.id">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <Link :href="route('pricings.edit', pricing.id)" class="text-indigo-600 hover:text-indigo-900"><img src="/images/pen_icon.svg" alt="Edit" class="dark_meta_tags_icons inline-block"/></Link>
