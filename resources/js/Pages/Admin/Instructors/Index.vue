                                    ...
                                    <tr v-for="instructorUser in instructors" :key="instructorUser.id" class="transition-colors duration-150 hover:bg-gray-50 dark:hover:bg-[#1b2c3f]">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-4">
                                                <Link :href="route('admin.instructors.show', { user: instructorUser.id })" class="text-gray-900 hover:text-gray-700 cursor-pointer dark:invert"><img src="/images/view_icon.svg" alt="View" class="w-4 h-4 action-icon"></Link>
