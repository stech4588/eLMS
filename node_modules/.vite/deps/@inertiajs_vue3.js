...
var _ = (r4) => w("before", { cancelable: true, detail: { visit: r4 } });
var ue = (r4) => w("error", { detail: { errors: r4 } });
var pe = (r4) => w("exception", { cancelable: true, detail: { exception: r4 } });
var de = (r4) => w("finish", { detail: { visit: r4 } });
var he = (r4) => w("invalid", { cancelable: true, detail: { response: r4 } });
var R = (r4) => w("navigate", { detail: { page: r4 } });
var me = (r4) => w("progress", { detail: { progress: r4 } });
var fe = (r4) => w("start", { detail: { visit: r4 } });
var ge = (r4) => w("success", { detail: { page: r4 } });
var ve = (r4, e) => w("prefetched", { detail: { fetchedAt: Date.now(), response: r4.data, visit: e } });
var be = (r4) => w("prefetching", { detail: { visit: r4 } });
var f = class {
  static set(e, t) {
...
f.locationVisitKey = "inertiaLocationVisit";
var ye = async (r4) => {
...
var we = () => {
  ...
  return f.set(q.iv, Array.from(e)), e;
};
var $e = async () => typeof window.crypto.subtle > "u" ? (console.warn("Encryption is not supported in this environment. SSL is required."), Promise.resolve(null)) : window.crypto.subtle.generateKey({ name: "AES-GCM", length: 256 }, true, ["encrypt", "decrypt"]);
var Ge = async (r4) => {
  ...
  f.set(q.key, Array.from(new Uint8Array(e)));
};
var Ke = async (r4) => {
  if (r4) return r4;
  let e = await $e();
  return e ? (await Ge(e), e) : null;
};
var Se = async () => {
  let r4 = f.get(q.key);
...
var Y = (r4) => r4 instanceof FormData;
function Z(r4, e = new FormData(), t = null) {
  r4 = r4 || {};
  for (let i in r4) Object.prototype.hasOwnProperty.call(r4, i) && Re(e, Ee(t, i), r4[i]);
  return e;
}
function Ee(r4, e) {
  return r4 ? r4 + "[" + e + "]" : e;
...
function Re(r4, e, t) {
  if (Array.isArray(t)) return Array.from(t.keys()).forEach((i) => Re(r4, Ee(e, i.toString()), t[i]));
...
var Te = (r4, e, t, i, s) => {
  ...
  if ((N(e) || i) && !Y(e) && (e = Z(e)), Y(e)) return [o, e];
  let [u, d] = xe(t, o, e, s);
  return [y(u), d];
};
function xe(r4, e, t, i = "brackets") {
  ...
  return r4 === "get" && Object.keys(t).length && (c.search = M.stringify(mergeWith(M.parse(c.search, { ignoreQueryPrefix: true }), t, (l, h3, F, P) => {
    h3 === void 0 && delete P[F];
...
var te = class {
  ...
  set(e, { replace: t = false, preserveScroll: i = false, preserveState: s = false } = {}) {
    ...
    return e.clearHistory && a.clear(), this.resolve(e.component).then((u) => {
      ...
      return t = t || I(y(e.url), d), new Promise((p) => {
        ...
        return this.page = e, this.cleared = false, p && this.fireEventsFor("newComponent"), this.isFirstPageLoad && this.fireEventsFor("firstLoad"), this.isFirstPageLoad = false, this.swap({ component: u, page: e, preserveState: s }).then(() => {
          i || v.reset(), S.fireInternalEvent("loadDeferredProps"), t || R(e);
        });
      });
    });
  }
...
var re = class {
  ...
  decrypt(e = null) {
    var _a;
    if (k) return Promise.resolve(e ?? n.get());
  ...
  handlePopstateEvent(e) {
    ...
    a.decrypt(t.page).then((i) => {
      ...
      n.setQuietly(i, { preserveState: false }).then(() => {
        v.restore(a.getScrollRegions()), R(n.get());
      });
    }).catch(() => {
      this.onMissingHistoryItem();
    });
...
var $ = class {
  ...
  static handleBackForward() {
    ...
    return a.decrypt().then((t) => {
      ...
      S.onMissingHistoryItem();
    }), true;
  }
  static handleLocation() {
    if (!f.exists(f.locationVisitKey)) return false;
    let e = f.get(f.locationVisitKey) || {};
    return f.remove(f.locationVisitKey), typeof window < "u" && n.setUrlHash(window.location.hash), a.decrypt(n.get()).then(() => {
      ...
      n.remember(t), n.set(n.get(), { preserveScroll: e.preserveScroll, preserveState: true }).then(() => {
        e.preserveScroll && v.restore(i), R(n.get());
      });
    }).catch(() => {
      S.onMissingHistoryItem();
    }), true;
  ...
  static handleDefault() {
    typeof window < "u" && n.setUrlHash(window.location.hash), n.set(n.get(), { preserveScroll: true, preserveState: true }).then(() => {
      B.isReload() && v.restore(a.getScrollRegions()), R(n.get());
    });
  }
};
var G = class {
...
var oe = (r4, e, t) => {
  if (r4 === e) return true;
  for (let i in r4) if (!t.includes(i) && r4[i] !== e[i] && !We(r4[i], e[i])) return false;
  return true;
};
var We = (r4, e) => {
  switch (typeof r4) {
...
var Xe = { ms: 1, s: 1e3, m: 6e4, h: 36e5, d: 864e5 };
var ae = (r4) => {
  if (typeof r4 == "number") return r4;
  for (let [e, t] of Object.entries(Xe)) if (r4.endsWith(e)) return parseFloat(r4) * t;
  return parseInt(r4);
};
var le = class {
  constructor() {
  ...
  paramsAreEqual(e, t) {
    return oe(e, t, ["showProgress", "replace", "prefetch", "onBefore", "onStart", "onProgress", "onFinish", "onCancel", "onSuccess", "onError", "onPrefetched", "onCancelToken", "onPrefetching", "async"]);
  }
};
var T = new le();
var K = class r {
...
var Ae = { modal: null, listener: null, show(r4) {
...
var O = class r2 {
  ...
  async process() {
    ...
    ge(n.get()), await this.requestParams.all().onSuccess(n.get()), a.preserveUrl = false;
  }
  mergeParams(e) {
  ...
  locationVisit(e) {
    try {
      if (f.set(f.locationVisitKey, { preserveScroll: this.requestParams.all().preserveScroll === true }), typeof window > "u") return;
...
var j = class {
  ...
  init({ initialPage: e, resolveComponent: t, swapComponent: i }) {
    n.init({ initialPage: e, resolveComponent: t, swapComponent: i }), $.handle(), S.init(), S.on("missingHistoryItem", () => {
      typeof window < "u" && this.visit(window.location.href, { preserveState: true, preserveScroll: true, replace: true });
    }), S.on("loadDeferredProps", () => {
  ...
  prefetch(e, t = {}, { cacheFor: i = 3e4 }) {
    ...
    if (d.onBefore(s) === false || !_(s)) return;
    ...
    new Promise((l) => {
      ...
      T.add(p, (l) => {
        this.asyncRequestStream.send(U.create(l, n.get()));
      }, { cacheFor: i });
    });
  }
  clearHistory() {
...
function Fe(r4, e, t) {
  ...
  function p() {
    let l = e(""), h3 = { ...l ? { title: `<title inertia="">${l}</title>` } : {} }, F = Object.values(i).reduce((P, E2) => P.concat(E2), []).reduce((P, E2) => {
      if (E2.indexOf("<") === -1) return P;
      if (E2.indexOf("<title ") === 0) {
        let H = E2.match(/(<title [^>]+>)(.*?)(<\/title>)/);
        return P.title = H ? `${H[1]}${e(H[2])}${H[3]}` : E2, P;
      }
      let ce = E2.match(/ inertia="[^"]+"/);
      return ce ? P[ce[0]] = E2 : P[Object.keys(P).length] = E2, P;
    }, h3);
...
var x = null;
var ze = (r4) => {
  Object.assign(g, r4), g.includeCSS && rt(g.color);
};
var Q = (r4) => {
  let e = Ie();
  r4 = De(r4, g.minimum, 1), x = r4 === 1 ? null : r4;
  let t = Ye(!e), i = t.querySelector(g.barSelector), s = g.speed, o = g.easing;
  t.offsetWidth, tt((u) => {
    let d = g.positionUsing === "translate3d" ? { transition: `all ${s}ms ${o}`, transform: `translate3d(${J(r4)}%,0,0)` } : g.positionUsing === "translate" ? { transition: `all ${s}ms ${o}`, transform: `translate(${J(r4)}%,0)` } : { marginLeft: `${J(r4)}%` };
...
var _e = (r4) => {
  !r4 && !x || (ke(0.3 + 0.5 * Math.random()), Q(1));
};
var ke = (r4) => {
  let e = x;
  if (e === null) return Le();
...
var Ye = (r4) => {
  var _a;
  if (Ze()) return document.getElementById(m);
  document.documentElement.classList.add(`${m}-busy`);
  let e = document.createElement("div");
  e.id = m, e.innerHTML = g.template;
  let t = e.querySelector(g.barSelector), i = r4 ? "-100" : J(x || 0), s = Oe();
  return t.style.transition = "all 0 linear", t.style.transform = `translate3d(${i}%,0,0)`, g.showSpinner || ((_a = e.querySelector(g.spinnerSelector)) == null ? void 0 : _a.remove()), s !== document.body && s.classList.add(`${m}-custom-parent`), s.appendChild(e), e;
};
var Oe = () => et(g.parent) ? g.parent : document.querySelector(g.parent);
var Ue = () => {
  var _a;
  document.documentElement.classList.remove(`${m}-busy`), Oe().classList.remove(`${m}-custom-parent`), (_a = document.getElementById(m)) == null ? void 0 : _a.remove();
};
var Ze = () => document.getElementById(m) !== null;
var et = (r4) => typeof HTMLElement == "object" ? r4 instanceof HTMLElement : r4 && typeof r4 == "object" && r4.nodeType === 1 && typeof r4.nodeName == "string";
function De(r4, e, t) {
...
var it = () => {
  let r4 = document.getElementById(m);
  r4 && (r4.style.display = "");
};
var st = () => {
  let r4 = document.getElementById(m);
...
var b = { configure: ze, isStarted: Ie, done: _e, set: Q, remove: Ue, start: Le, status: x, show: it, hide: st };
var z = 0;
var W = (r4 = false) => {
...
function nt(r4) {
  document.addEventListener("inertia:start", (e) => ot(e, r4)), document.addEventListener("inertia:progress", at2);
}
function ot(r4, e) {
  r4.detail.visit.showProgress || X();
  let t = setTimeout(() => b.start(), e);
  document.addEventListener("inertia:finish", (i) => lt(i, t), { once: true });
}
function at2(r4) {
  var _a;
...
function He({ delay: r4 = 250, color: e = "#29d", includeCSS: t = true, showSpinner: i = false } = {}) {
  nt(r4), b.configure({ showSpinner: i, includeCSS: t, color: e });
}
function Ne(r4) {
...
function x2(e, r4) {
  let n2 = typeof e == "string" ? e : null, s = (typeof e == "string" ? r4 : e) ?? {}, o = n2 ? jr.restore(n2) : null, a2 = typeof s == "function" ? cloneDeep(s()) : cloneDeep(s), l = null, f2 = null, m2 = (t) => t, v2 = reactive({ ...o ? o.data : cloneDeep(a2), isDirty: false, errors: o ? o.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    let i = typeof t[0] == "object", d = i ? t[0].method : t[0], p = i ? t[0].url : t[1], u = (i ? t[1] : t[2]) ?? {}, F = m2(this.data()), T2 = { ...u, onCancelToken: (c) => {
    ...
    d === "delete" ? jr.delete(p, { ...T2, data: F }) : jr[d](p, F, T2);
  }, get(t, i) {
    this.submit("get", t, i);
  }, post(t, i) {
  ...
  return watch(v2, (t) => {
    v2.isDirty = !isEqual(v2.data(), a2), n2 && jr.remember(cloneDeep(t.__remember()), n2);
...
var ie2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  return E = Fe(a2, s, o), a2 || (jr.init({ initialPage: e, resolveComponent: n2, swapComponent: async (l) => {
    y2.value = markRaw(l.component), h2.value = l.page, A2.value = l.preserveState ? A2.value : Date.now();
  } }), jr.on("navigate", () => E.forceUpdate())), () => {
    if (y2.value) {
      y2.value.inheritAttrs = !!y2.value.inheritAttrs;
      let l = h(y2.value, { ...h2.value.props, key: A2.value });
      return I2.value && (y2.value.layout = I2.value, I2.value = null), y2.value.layout ? typeof y2.value.layout == "function" ? y2.value.layout(h, l) : (Array.isArray(y2.value.layout) ? y2.value.layout : [y2.value.layout]).concat(l).reverse().reduce((f2, m2) => (m2.inheritAttrs = !!m2.inheritAttrs, h(m2, { ...h2.value.props }, () => f2))) : l;
    }
  };
} });
var B2 = ie2;
var q2 = { install(e) {
  jr.form = x2, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => jr }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => h2.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => E }), e.mixin(V2);
} };
function ae2() {
...
async function K2({ id: e = "app", resolve: r4, setup: n2, title: s, progress: o = {}, page: a2, render: l }) {
  let f2 = typeof window > "u", m2 = f2 ? null : document.getElementById(e), v2 = a2 || JSON.parse(m2.dataset.page), t = (p) => Promise.resolve(r4(p)).then((u) => u.default || u), i = [], d = await Promise.all([t(v2.component), jr.decryptHistory().catch(() => {
...
var Te2 = defineComponent({ name: "Link", props: { as: { type: String, default: "a" }, data: { type: Object, default: () => ({}) }, href: { type: [String, Object], required: true }, method: { type: String, default: "get" }, replace: { type: Boolean, default: false }, preserveScroll: { type: Boolean, default: false }, preserveState: { type: Boolean, default: null }, only: { type: Array, default: () => [] }, except: { type: Array, default: () => [] }, headers: { type: Object, default: () => ({}) }, queryStringArrayFormat: { type: String, default: "brackets" }, async: { type: Boolean, default: false }, prefetch: { type: [Boolean, String, Array], default: false }, cacheFor: { type: [Number, String, Array], default: 0 }, onStart: { type: Function, default: (e) => {
  ...
  let f2 = typeof e.href == "object" ? e.href.method : e.method.toLowerCase(), m2 = f2 !== "get" ? "button" : e.as.toLowerCase(), v2 = computed(() => xe(f2, typeof e.href == "object" ? e.href.url : e.href || "", e.data, e.queryStringArrayFormat)), t = computed(() => v2.value[0]), i = computed(() => v2.value[1]), d = computed(() => ({ a: { href: t.value }, button: { type: "button" } })), p = { data: i.value, method: f2, replace: e.replace, preserveScroll: e.preserveScroll, preserveState: e.preserveState ?? f2 !== "get", only: e.only, except: e.except, headers: e.headers, async: e.async }, u = { ...p, onCancelToken: e.onCancelToken, onBefore: e.onBefore, onStart: (g2) => {
    ...
    jr.prefetch(t.value, p, { cacheFor: l });
  }, T2 = { onClick: (g2) => {
    Ne(g2) && (g2.preventDefault(), jr.visit(t.value, u));
  } }, c = { onMouseenter: () => {
    o.value = setTimeout(() => {
      F();
    }, 75);
    ...
    Ne(g2) && (g2.preventDefault(), F());
  }, onMouseup: (g2) => {
    g2.preventDefault(), jr.visit(t.value, u);
  }, onClick: (g2) => {
    Ne(g2) && g2.preventDefault();
  } };
  return () => h(m2, { ...n2, ...d.value[m2] || {}, "data-loading": s.value > 0 ? "" : void 0, ...a2.includes("hover") ? c : a2.includes("click") ? w2 : T2 }, r4);
} });
var Se2 = Te2;
function W2(e, r4 = {}, n2 = { keepAlive: false, autoStart: true }) {
  let { stop: s, start: o } = jr.poll(e, r4, { ...n2, autoStart: false });
  return onMounted(() => {
    (n2.autoStart ?? true) && o();
  }), onUnmounted(() => {
    s();
...
function J2(e = {}) {
  let r4 = ref(false), n2 = ref(null), s = ref(false), o = typeof window > "u" ? null : jr.getCached(window.location.pathname, e), a2 = typeof window > "u" ? null : jr.getPrefetching(window.location.pathname, e);
  n2.value = (o == null ? void 0 : o.staleTimestamp) || null, r4.value = a2 !== null, s.value = o !== null;
  let l, f2;
  return onMounted(() => {
    f2 = jr.on("prefetching", (m2) => {
      m2.detail.visit.url.pathname === window.location.pathname && (r4.value = true);
    }), l = jr.on("prefetched", (m2) => {
      m2.detail.visit.url.pathname === window.location.pathname && (r4.value = false, s.value = true);
    });
  }), onUnmounted(() => {
    l(), f2();
  }), { lastUpdatedAt: n2, isPrefetching: r4, isPrefetched: s, flush: () => jr.flush(window.location.pathname, e) };
}
function Q2(e, r4) {
  if (typeof e == "object" && e !== null && e.__rememberable === false) return e;
  let n2 = jr.restore(r4), s = isReactive(e) ? reactive : ref, o = typeof e.__remember == "function" && typeof e.__restore == "function", a2 = s(n2 === void 0 ? e : o ? e.__restore(n2) : n2);
  return watch(a2, (l) => {
    jr.remember(cloneDeep(o ? e.__remember() : l), r4);
